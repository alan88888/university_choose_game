...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let playerX = parseFloat(urlParams.get('playerX')) || 15;
    let playerY = parseFloat(urlParams.get('playerY')) || 300;
    ...
    openBagButton.addEventListener("click", function() {
        ...
        window.location.href = `../Bag/bag.html?from=map4&playerX=${currentLeft}&playerY=${currentTop}`;
    });
});
...
function checkInteraction() {
    ...
    if (
        ...
        window.location.href = "../M3/map3.html?from=map4";
    }
}
